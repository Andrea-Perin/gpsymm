...
def main():
    ...
    grid[0].set_title('Regression', fontsize=10)
    grid[0].plot(angles, reg_avg, '-o')
    grid[0].fill_between(angles, reg_avg-reg_c95, reg_avg+reg_c95, alpha=.2)

    grid[1].set_title('Training', fontsize=10)
    grid[1].plot(angles, train_avg, '-o')
    grid[1].fill_between(angles, train_avg-train_c95, train_avg+train_c95, alpha=.2)

    grid[2].set_title('Spectral', fontsize=10)
